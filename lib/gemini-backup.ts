...
export async function generateArticleAnalysis(
  ...
  try {
    ...
    const prompt = `You are an expert content analyst. Read the article content carefully and perform these tasks:

1. DETECT the primary language of the article
2. CATEGORIZE the article based on its PRIMARY CONTENT TOPIC
3. Generate summaries in Chinese and English
4. Provide English translations if needed

IMPORTANT: Base your categorization on the ACTUAL CONTENT, not just the title.`
