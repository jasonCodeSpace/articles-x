...
export function TwoLevelCategoryDropdown({
  ...
  return (
    <div className="relative">
      ...
      {isOpen && (
        <div className="absolute left-0 top-full mt-2 z-50 min-w-[200px] max-h-[400px] overflow-y-auto bg-[#0A0A0A]/95 backdrop-blur-xl border border-white/10 rounded-2xl p-2 shadow-2xl">
